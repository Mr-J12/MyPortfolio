    ...
    <>
      <style>{`
        ...
        .chatbot-btn {
          ...
          font-size: 26px;
          box-shadow: 0 0 25px rgba(59,130,246,0.5), 0 8px 25px rgba(0,0,0,0.4);
        ...
        .chatbot-window {
          ...
          box-shadow: 0 0 50px rgba(59,130,246,0.2), 0 30px 60px rgba(0,0,0,0.6);
        ...
        .chat-input::placeholder { color: rgba(147,197,253,0.4); }
